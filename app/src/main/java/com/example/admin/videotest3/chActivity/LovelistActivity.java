...
public class LovelistActivity extends AppCompatActivity {
    ...
    public void showLovelist(){
        initThumbnail();
        ThumbnailAdapter adapter = new ThumbnailAdapter(LovelistActivity.this,R.layout.love_item,ThumbnailList_love);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                Thumbnail thumbnail = ThumbnailList_love.get(position);
                //Toast.makeText(MainActivity.this,thumbnail.getTitle(),Toast.LENGTH_SHORT).show();
                Toast.makeText(LovelistActivity.this,thumbnail.getId(),Toast.LENGTH_SHORT).show();
    ...
    private void go2Player(String id) {
        Intent i = new Intent(LovelistActivity.this, PlayActivity.class);
        i.putExtra("vid", id);
        LovelistActivity.this.startActivity(i);
    }
}
