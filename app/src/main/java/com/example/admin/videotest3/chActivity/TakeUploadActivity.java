...
import com.example.admin.videotest3.myclass.FormatUtil;
...
public class TakeUploadActivity extends Activity {


    private String tag ="Haochen_______Upload";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button start_take = (Button) findViewById(R.id.button_start_take_video);
        VideoView videoView_take = (VideoView) findViewById(R.id.video_taking);
        start_take.setOnClickListener(this);
        videoView_take.setOnClickListener(this);
*/
        initCamera();
        initViews();
    }
...
//						parameters.setPreviewFrameRate(5); // 每秒5帧
    ...
    class SavePictureTask extends AsyncTask<byte[], String, String> {
        ...
        protected String doInBackground(byte[]... params) {
            ...
            Log.e(tag, "=====照片保存完成=====");
            TakeUploadActivity.this.finish();
            return null;
        }
    }
...
/*
    public void onClick(View v){
        ...
        case R.id.button_start_take_video:


        break;
        case R.id.video_taking:
